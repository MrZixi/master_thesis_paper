...
\documentclass[
    ...
    ColaboratorName = 于智,
    % Title
    % Title           = 流行歌曲自动翻译与翻唱自动合成研究,
    % TitleEng        = {{Automatic Song Translation and Singing Voice Synthesis on Pop Songs}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{流行歌曲自动翻译与}{翻唱自动合成研究}
\titleengtwolines{Automatic Song Translation and}{Singing Voice Synthesis on Pop Songs}
